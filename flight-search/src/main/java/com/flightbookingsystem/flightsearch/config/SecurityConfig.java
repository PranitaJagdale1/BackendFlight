...
//websecurityconfigureradaptar :- it is a class that allows websecurity and http security
//websecurity ;- external outlet of spring security
//Httpsecurity :- internal security
